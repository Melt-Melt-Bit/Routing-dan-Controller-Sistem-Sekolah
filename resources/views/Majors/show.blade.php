    ...
    <div class="mt-3 border border-[#E5E3DB] bg-white">
        ...
        <dl class="divide-y divide-[#EFEDE6] text-sm">
            <div class="flex justify-between px-8 py-4">
                <dt class="text-xs uppercase tracking-[0.1em] text-slate-400">Kode Jurusan</dt>
            ...
            <div class="flex justify-between gap-8 px-8 py-4">
                <dt class="shrink-0 text-xs uppercase tracking-[0.1em] text-slate-400">Deskripsi</dt>
                <dd class="text-right font-medium text-[#16213A]">{{ $major['description'] }}</dd>
            </div>
        </dl>
